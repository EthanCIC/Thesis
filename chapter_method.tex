...
\fig[0.75][fig:FSR_laser][!htb]{FSR_laser.png}[Fabry-Perot 干涉儀 FSR 測量]
\fig[0.75][fig:laser_bandwidth][!htb]{laser_bandwidth.png}[Fabry-Perot 干涉儀頻寬測量]
