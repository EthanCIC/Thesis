...
\fig[0.5][fig:spread_sprectrum_simulation][!htb]{spread_sinc.png}[展寬後頻譜模擬圖]
...
\fig[0.5][fig:electric_mismatch][!htb]{phase_mismatch.png}[不同電訊號時間差之頻譜壓縮。黑線為 $\Delta t_{p}=\Delta t_{RF}$；紅線為 $\Delta t_{p}>\Delta t_{RF}$。]
...
\fig[0.5][fig:compress_comparison][!htb]{abs_compress_compare.png}[展頻後吸收對頻譜壓縮之影響。黑線為沒放 $^{87}Rb$ 原子氣體管；紅線為有 $^{87}Rb$ 原子氣體管。][展頻後吸收對壓縮之影響]
