...
\subsection{隨機訊號}
從單頻波調製的例子可看出，可將原先頻率集中於 $\nu_{0}$ 的光，分散至 $\nu_{0}\pm\nu_{m}, \nu_{0}\pm2\nu_{m},\dots$，若調製函數改為時間寬度為 $\Delta T$ 的隨機方波的話，則可將頻譜展開如下：
（展頻圖）
其形狀接近 $sinc^2(\omega)$，展開的寬度為 $\pm\frac{1}{\Delta T}$，在我們實驗中使用的隨機訊號的產生率為 10 Gb/s，單一比特的時間寬度為 100 ps，相當於能將頻譜從數 MHz 展至 10 GHz 寬。
